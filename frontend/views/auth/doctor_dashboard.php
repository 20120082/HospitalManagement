                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <h5 class="card-title">Bệnh nhân của tôi</h5>
                                                <p class="card-text">Xem thông tin bệnh nhân mà bác sĩ đang điều trị</p>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <h5 class="card-title">Bệnh án của bệnh nhân</h5>
                                                <p class="card-text">Xem và ghi chú chẩn đoán cho bệnh án</p>
